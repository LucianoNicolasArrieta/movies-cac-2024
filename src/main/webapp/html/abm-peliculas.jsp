    ...
    <nav class="navbar fw-semibold">
        <div class="container-fluid justify-content-center justify-content-md-between flex-column flex-md-row">
            <div class="pb-2 p-md-0 d-flex align-items-center">
                ...
                <a class="navbar-brand text-white" href="../index.html">CAC-Movies</a>
            </div>
            <div>
        ...
        <div class="w-50">
            ...
            <form action="" method="post" class="d-flex flex-column align-items-center">
                ...
                <div class="container-fluid d-flex flex-column justify-content-center align align-items-center">
                    <button type="submit" class="boton-prim btn rounded-3 w-100" id="crear-pelicula">Añadir</button>
                    <a href="../index.html" class="btn-secondary mt-4">Cancelar</a>
                </div>
            </form>
        </div>
    </div>
...
<footer>
    <div id="footer"
        ...
        <a href="abm-peliculas.html" class="fs-6 text-decoration-none text-white fw-semibold mx-3 my-1 rounded-2"
