...
<header class="">
    <nav class="navbar fw-semibold">
        <div class="container-fluid justify-content-center justify-content-md-between flex-column flex-md-row">
            ...
            <div>
                <a class="nav-item nav-link d-inline px-md-4 py-md-2 mx-2" href="../index.jsp">Tendencias</a>
                <a class="nav-item nav-link d-inline px-md-4 py-md-2 mx-2" href="registro.html">Registrarse</a>
                <a class="nav-item nav-link d-inline px-md-4 py-md-2 mx-2" href="login.html"
                   id="login-btn">Iniciar
                    Sesión</a>
            </div>
        </div>
    </nav>
...
<%  Conexion conexion = new Conexion();
    ...
    Pelicula pelicula = peliculaService.getPeliculaById(Integer.parseInt(request.getParameter("id")));
%>
<main class="aos-init" data-aos="zoom-in" data-aos-duration="1000" style="background-image: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url(<%=pelicula.getFondo()%>)">

    <section>
        <div class="container-fluid d-flex p-5 flex-column justify-content-start flex-lg-row">
            <img src="<%=pelicula.getPortada()%>" alt="Miniatura película"
                 class="img-fluid rounded-4 align-self-center align-self-lg-start" width="300px" height="450px">
            <div class="ms-lg-5 d-flex flex-column justify-content-center">
                <div id="info-peli" class="">
                    <h1><%=pelicula.getTitulo()%></h1>
                    <p><%=pelicula.getFechaDeEstreno()%> • <%=pelicula.getCategorias()%> • <%=pelicula.getDuracion()%>min</p>
                </div>
                <div>
...
<section id="section-trailer-redes-info" class="mt-4" class="aos-init" data-aos="fade-up" data-aos-duration="1000" data-aos-anchor-placement="center-bottom">
    <div class="d-lg-flex align-items-lg-center">
        <div class="container-fluid w-auto">
            <h2 class="fs-4">Ver Trailer</h2>
            <div class="video-container" class="mt-2">
                <iframe src="<%=pelicula.getTrailer()%>" title="YouTube video player"
                        frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </div>
        </div>
        <div id="redes-info" class="container-fluid">
            <div class="container-fluid d-flex justify-content-between my-2">
                <a href="https://www.facebook.com/supermariomovie"><svg width="50px" height="50px" viewBox="0 0 24 24"
                ...
                <a href="https://twitter.com/supermariomovie">
                ...
                <a href="https://www.instagram.com/supermariomovie/">
                    <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                         stroke="#ffffff" stroke-width="0.00024000000000000003">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                ...
                <a href="https://www.uphe.com/movies/the-super-mario-bros-movie">
                    <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                         stroke="#ffffff" stroke-width="0.00024000000000000003">
                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
            ...
            <div class="d-flex justify-content-evenly">
                <div>
                    ...
                    <p class="fw-semibold">Budget</p>
                    <p class="fw-semibold">Revenue</p>
                </div>
                <div class="ps-lg-3">
                    <p><%=pelicula.getEstado()%></p>
                    <p><%=pelicula.getLenguajeOriginal()%></p>
                    <p>$<%=String.valueOf(pelicula.getPresupuesto())%></p>
                    <p>$<%=String.valueOf(pelicula.getIngresos())%></p>
                </div>
            </div>
        </div>
    </div>
